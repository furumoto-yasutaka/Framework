...
public:
	OBBCollider3D(GameObject* attachObject)
		: Collider3D(attachObject, Collider3D::ColliderId::OBB)
	{}
	~OBBCollider3D() {}
	...
	void SetLocalRadius(D3DXVECTOR3 radius) { m_LocalRadius = radius; }
	/////////////////////////////
